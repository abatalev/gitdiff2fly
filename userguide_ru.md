...
|  6   | Создаём или клонируем готовый репозиторий, где будут хранится наши файлы для подготовки сборок | **git clone url test_repo** или **mkdir test_repo & git init** |
...
У нас есть директория test_repo, в которой хранятся наши скрипты и файлы для миграций Flyway.

<img src="img/image-20210704215705673.png" alt="image-20210704215705673" style="zoom:33%;" />
...
![image-20210704220546114](img/image-20210704220546114.png)
...
![image-20210704221214457](img/image-20210704221214457.png)
...
![image-20210704222923512](img/image-20210704222923512.png)